document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            about_desc: 'Automation-focused QA Engineer with 6+ years of experience delivering high-quality, reliable, and scalable software solutions.<br><br>I specialize in designing and building robust test automation frameworks for web applications. I am trained in Selenium with C#, and I have hands-on experience implementing Playwright with TypeScript for projects, focusing on test reliability, execution speed, and maintainability. I also leverage AI-assisted coding tools to accelerate development and enhance productivity.<br><br>Experienced in UI and API testing, I focus on creating efficient, maintainable, and scalable automation solutions aligned with modern development practices.',
            about_languages_label: 'Languages:',
            about_languages: 'English, Malayalam, Hindi, Dutch (Beginner level)',
            ...
            exp_box1_li1: 'Applied hands-on expertise with Playwright and TypeScript for project automation, improving test reliability and execution speed.',
            exp_box1_li2: 'Completed training in Selenium with C# to support and expand web application testing capabilities.',
            exp_box1_li3: 'Leveraged GitHub Copilot to accelerate script development and enhance overall productivity.',
            exp_box1_li4: 'Integrated AI-assisted tools into the development workflow for faster and more efficient delivery.',
        ...
        nl: {
            ...
            about_desc: 'Automatiseringsgerichte QA Engineer met meer dan 6 jaar ervaring in het leveren van hoogwaardige, betrouwbare en schaalbare softwareoplossingen.<br><br>Ik ben gespecialiseerd in het ontwerpen en bouwen van robuuste testautomatiseringsframeworks voor webapplicaties. Ik ben opgeleid in Selenium met C# en ik heb praktische ervaring met het implementeren van Playwright met TypeScript voor projecten, waarbij de focus ligt op testbetrouwbaarheid, uitvoeringssnelheid en onderhoudbaarheid. Ik maak ook gebruik van AI-ondersteunde coderingstools om de ontwikkeling te versnellen en de productiviteit te verhogen.<br><br>Ervaren in UI- en API-testen, richt ik mij op het creëren van efficiënte, onderhoudbare en schaalbare automatiseringsoplossingen die aansluiten bij moderne ontwikkelpraktijken.',
            about_languages_label: 'Talen:',
            about_languages: 'Engels, Malayalam, Hindi, Nederlands (Beginnersniveau)',
            ...
            exp_box1_li1: 'Praktische expertise toegepast met Playwright en TypeScript voor projectautomatisering, waardoor de betrouwbaarheid en snelheid van tests zijn verbeterd.',
            exp_box1_li2: 'Training in Selenium met C# voltooid ter ondersteuning en uitbreiding van de testmogelijkheden voor webapplicaties.',
            exp_box1_li3: 'GitHub Copilot ingezet om de ontwikkeling van scripts te versnellen en de algehele productiviteit te verbeteren.',
            exp_box1_li4: 'AI-ondersteunde tools geïntegreerd in de ontwikkelworkflow voor een snellere en efficiëtere levering.',
            exp_box2_title: 'QA Engineer',
            exp_box2_company: 'SAP Labs India | Bangalore | Karnataka | India',
        ...
        de: {
            ...
            exp_box1_li1: 'Praktische Expertise mit Playwright und TypeScript für die Projektautomatisierung angewendet, was die Testzuverlässigkeit und Ausführungsgeschwindigkeit verbesserte.',
            exp_box1_li2: 'Schulung in Selenium mit C# absolviert, um die Testkapazitäten für Webanwendungen zu unterstützen und zu erweitern.',
            exp_box1_li3: 'GitHub Copilot genutzt, um die Skriptentwicklung zu beschleunigen und die Gesamtproduktivität zu steigern.',
            exp_box1_li4: 'KI-gestützte Tools in den Entwicklungs-Workflow integriert für eine schnellere und effizientere Projektabwicklung.',
